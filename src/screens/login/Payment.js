...
import { GetRegistrationAmount } from "../../store/actionTypes/RegistrationLut";
...
export default function Payment() {
  ...
  console.log(userData, registrationFee, "PAY1");
    ...
    <ScrollView className="p-3">
      ...
      <View className="p-5 mb-4 bg-white rounded-lg">
        <View className="flex-row items-center justify-between">
          ...
          <View className="h-5 w-5 bg-slate-200 border-2 border-black rounded-full"></View>
        </View>
      ...
      <View className="p-5 mb-4 bg-white rounded-lg">
        ...
        <View className="mb-4 flex-row items-center justify-between">
          <View>
            <Text className="font-semibold text-green-700">Discount (5%)</Text>
          </View>
